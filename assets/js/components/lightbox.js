...
(function (global, factory) {
    ...
    (global = global || self, global.dgtUIkitLightbox = factory(global.dgtUIkit.util));
            ...
            toggleElement: function(targets, show, animate) {
                ...
                return new uikitUtil.Promise(function (resolve) {
                    ...
                    if (!this$1.queued || !uikitUtil.isUndefined(animate) || !uikitUtil.isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = uikitUtil.Animation.inProgress(el) && uikitUtil.hasClass(el, 'dgt-animation-leave')
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = uikitUtil.isBoolean(show)
                    ...
                    : uikitUtil.Animation.inProgress(el)
                        ? uikitUtil.hasClass(el, 'dgt-animation-leave')
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.toggleClass(uikitUtil.$$(this.selNavItem, this.$el).concat(this.nav), 'dgt-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    uikitUtil.toggleClass(el, 'dgt-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        computed: {
            ...
            caption: function(ref, $el) {
                ...
                return uikitUtil.$('.dgt-lightbox-caption', $el);
            }
...

            {
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) {
                        ...
                        var video = uikitUtil.$(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " dgt-video=\"" + (this.videoAutoplay) + "\"></video>"));
        ...
        methods: {
            ...
            showControls: function() {
                ...
                uikitUtil.addClass(this.$el, 'dgt-active', 'dgt-transition-active');

            },

            hideControls: function() {
                uikitUtil.removeClass(this.$el, 'dgt-active', 'dgt-transition-active');
            }
    ...
    var Component = {
        ...
        computed: {
            ...
            items: function() {
                return uikitUtil.uniqueBy(this.toggles.map(toItem), 'source');
            }
        ...
        events: [

            {
                ...
                handler: function(e) {
                    e.preventDefault();
                    var src = uikitUtil.data(e.current, 'href');
                    this.show(uikitUtil.findIndex(this.items, function (ref) {
        ...
        methods: {
            ...
            show: function(index) {
                ...
                this.panel = this.panel || this.$create('lightboxPanel', uikitUtil.assign({}, this.$props, {items: this.items}));
    ...
    function install(dgtUIkit, Lightbox) {
    ...
    /* global dgtUIkit, 'lightbox' */

    if (typeof window !== 'undefined' && window.dgtUIkit) {
        window.dgtUIkit.component('lightbox', Component);
    }
