...
(function (global, factory) {
    ...
    (global = global || self, global.dgtUIkitSlider = factory(global.dgtUIkit.util));
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.$$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && uikitUtil.toggleClass(el, 'dgt-hidden', uikitUtil.isNumeric(index) && (this$1.sets && !uikitUtil.includes(this$1.sets, uikitUtil.toFloat(index)) || index > this$1.maxIndex));
                });
    ...
    /* global dgtUIkit, 'slider' */

    if (typeof window !== 'undefined' && window.dgtUIkit) {
        window.dgtUIkit.component('slider', Component);
    }
