...
(function (global, factory) {
    ...
    (global = global || self, global.dgtUIkitSortable = factory(global.dgtUIkit.util));
    ...
    var Component = {
        ...
        methods: {
            ...
            start: function(e) {
                ...
                uikitUtil.attr(this.drag, 'dgt-no-boot', '');
    ...
    /* global dgtUIkit, 'sortable' */

    if (typeof window !== 'undefined' && window.dgtUIkit) {
        window.dgtUIkit.component('sortable', Component);
    }
